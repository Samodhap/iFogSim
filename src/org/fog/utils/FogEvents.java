...
public class FogEvents {
    ...
    //cluster connection related enums
    public static final int UPDATE_CLUSTER_TUPLE_QUEUE = BASE + 26;
    public static final int PROCESS_PRS = BASE + 27;
    public static final int UPDATE_SERVICE_DISCOVERY = BASE + 28;
