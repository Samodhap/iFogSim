...
public class ControllerComponent {
     ...
     */
    public Map<Integer, Map<String, Integer>> executeApplicationPlacementLogic(List<PlacementRequest> placementRequests) {
        if (microservicePlacementLogic != null) {
            Map<Integer, Map<String, Integer>> placement = microservicePlacementLogic.run(fogDeviceList, applicationInfo, resourceAvailability, placementRequests);
            return placement;
        }
